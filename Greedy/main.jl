...
for instance_name in instance_names #para i de 1 ao tamanho do vetor instance_names
   ...
   times = []
   for i = 1:iterations
      instance_file = "Tarefa 2/data/$(instance_name).txt" # instance_file recebe o nome do arquivo da instancia
      cod_metodo = 1
      ...
      cost_file = "Results/ConstrutivoDeterminístico/$(instance_name).csv"
      if !isfile(cost_file)
